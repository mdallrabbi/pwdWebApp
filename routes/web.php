...
Auth::routes();
Route::resource('implementorOrganization','ImplementorOrganizationController');

//===================================================================================================================

Route::group(['prefix' => 'budgets'], function(){
    Route::get('budgets_edit', function () { return view('pages.budgets.budgets_edit'); });
    Route::get('budgets_list', function () { return view('pages.budgets.budgets_list'); });
    Route::get('budgets_new', function () { return view('pages.budgets.budgets_new'); });
    Route::get('budgets_view', function () { return view('pages.budgets.budgets_view'); });
});

Route::group(['prefix' => 'implementors'], function(){
    Route::get('implementors_edit', function () { return view('pages.implementors.implementors_edit'); });
    Route::get('implementors_list', function () { return view('pages.implementors.implementors_list'); });
    Route::get('implementors_new', function () { return view('pages.implementors.implementors_new'); });
    Route::get('implementors_view', function () { return view('pages.implementors.implementors_view'); });
});

Route::group(['prefix' => 'progresses'], function(){
    Route::get('progresses_edit', function () { return view('pages.progresses.progresses_edit'); });
    Route::get('progresses_list', function () { return view('pages.progresses.progresses_list'); });
    Route::get('progresses_new', function () { return view('pages.progresses.progresses_new'); });
    Route::get('progresses_view', function () { return view('pages.progresses.progresses_view'); });
});

Route::group(['prefix' => 'projects'], function(){
    Route::get('projects_edit', function () { return view('pages.projects.projects_edit'); });
    Route::get('projects_list', function () { return view('pages.projects.projects_list'); });
    Route::get('projects_new', function () { return view('pages.projects.projects_new'); });
    Route::get('projects_view', function () { return view('pages.projects.projects_view'); });
});
